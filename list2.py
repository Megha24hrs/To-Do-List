...
class Todo:
    def __init__(self,root):
        ...
        self.label=Label(self.root,text='To-do-list-App',font='ariel, 25  bold',width=10,bd=5,bg='Light Blue',fg='black')
        ...
        self.button = Button(self.root,text="Add",font=('sarif',20,' bold italic'),
                             width=10,bd=5,bg='light blue',fg='black',command=add)
        self.button.place(x=40,y=190)
        self.button2 = Button(self.root,text="Delete",font=('sarif',20,' bold italic'),
                             width=10,bd=5,bg='light blue',fg='black',command=delete)
        self.button2.place(x=40,y=260)
